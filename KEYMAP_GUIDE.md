...
├──────┼──────┼──────┼──────┼──────┼──────┼──────┐    ┌──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│LSHFT │  Z   │  X   │  C   │  V   │  B   │  [   │    │  ]   │  N   │  M   │  ,   │  .   │  /   │  ろ   │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┤    ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│LCTRL │RCTRL │ GUI  │ ALT  │L2+英数│L1+SPC│L3+かな│   │ BSPC │L1+ENT│ none │ none │  -   │  ^   │  ¥   │
└──────┴──────┴──────┴──────┴──────┴──────┴──────┘    └──────┴──────┴──────┴──────┴──────┴──────┴──────┘
```

- `L1+SPC`: ホールドで Layer 1（ナビ・マウス）、タップで Space
- `L1+ENT`: ホールドで Layer 1（ナビ・マウス）、タップで Enter
- `L2+英数`: ホールドで Layer 2（記号・BT制御）、タップで英数（LANGUAGE_1）
- `L3+かな`: ホールドで Layer 3（Fn・マウス・ナビ）、タップでかな（LANGUAGE_2）
- `@`: JIS 配列での出力（US キーコード `LBKT`）
- `[`, `]`: JIS 配列での出力（US キーコード `RBKT` / `BSLH`）
- `ろ`: JIS 固有キー `INT_RO`（`\` / `_`）
- `¥`: JIS 固有キー `INT_YEN`
...
├──────┼──────┼──────┼──────┼──────┼──────┤                  ├──────┼──────┼──────┼──────┼──────┼──────┤
│      │ none │ none │ none │ none │ none │                  │ PgUp │LCLK  │MCLK  │RCLK  │MCLK  │ none │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┐    ┌──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│      │ none │ none │ none │ none │ none │ HOME │    │ END  │ PgDn │ MB4  │ none │ MB5  │  ↑   │ none │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┤    ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│      │      │      │      │無変換 │ ■■■  │ 変換 │    │ DEL  │ ■■■  │      │      │  ←   │  ↓   │  →   │
└──────┴──────┴──────┴──────┴──────┴──────┴──────┘    └──────┴──────┴──────┴──────┴──────┴──────┴──────┘
```
...
- 上段: 数字 `1`〜`0`
- 中段右: PgUp、マウスクリック（LCLK、MCLK、RCLK、MCLK）
- 下段右: PgDn、MB4（戻る）、MB5（進む）、↑、HOME/END
- 最下段左: `無変換`（INT_MUHENKAN）、`変換`（INT_HENKAN）
- 最下段右: DEL、矢印キー（←↓→）
- `none` = `&none`（何も割り当てなし）

### Layer 2 — 記号・BT制御レイヤー（左親指 英数 長押し）
...
### Layer 3 — ファンクション・マウス・ナビレイヤー（左親指 かな 長押し）

```
┌──────┬──────┬──────┬──────┬──────┬──────┐                  ┌──────┬──────┬──────┬──────┬──────┬──────┐
│      │  F1  │  F2  │  F3  │  F4  │  F5  │                  │  F6  │  F7  │  F8  │  F9  │ F10  │ F11  │
├──────┼──────┼──────┼──────┼──────┼──────┤                  ├──────┼──────┼──────┼──────┼──────┼──────┤
│      │ none │ none │ none │ none │ none │                  │ PgUp │LCLK  │MCLK  │RCLK  │MCLK  │ F12  │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┐    ┌──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│      │ none │ none │ none │ none │ none │ HOME │    │ END  │ PgDn │ MB4  │ none │ MB5  │  ↑   │ none │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┤    ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│      │      │      │      │      │      │ ▓▓▓▓ │    │ MB4  │ MB5  │      │      │  ←   │  ↓   │  →   │
...
- 上段: ファンクションキー `F1`〜`F5`（左）/ `F6`〜`F11`（右）
- 中段右: PgUp、マウスクリック（LCLK、MCLK、RCLK、MCLK）、`F12`
- 下段: `HOME` / `END`、PgDn、MB4（戻る）、MB5（進む）、↑
...
├──────┼──────┼──────┼──────┼──────┼──────┤                  ├──────┼──────┼──────┼──────┼──────┼──────┤
│      │ none │ none │ none │ none │ none │                  │ none │LCLK  │MCLK  │RCLK  │MCLK  │ none │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┐    ┌──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│      │ none │ none │ none │ none │ none │ none │    │ none │ none │ MB4  │ none │ MB5  │ none │ none │
├──────┼──────┼──────┼──────┼──────┼──────┼──────┤    ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤
│      │      │      │      │      │      │      │    │ none │      │      │      │ none │ none │ none │
└──────┴──────┴──────┴──────┴──────┴──────┴──────┘    └──────┴──────┴──────┴──────┴──────┴──────┴──────┘
```

- 中段右: マウスクリック（LCLK、MCLK、RCLK、MCLK）
- 下段右: MB4（戻る）、MB5（進む）
